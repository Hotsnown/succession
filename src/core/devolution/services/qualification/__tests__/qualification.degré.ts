...
it('should test degrés in ordre 1', () => {
    const data: MemberConstructor[] =  [
        ...
        {"member_id":"son","childs":["grand_son", "grand_son2"],"attributes":{"status": 'valid', "degre":"unassigned", "ordre": "unassigned", "branch": "unassigned", "isReprésentant": "unassigned", "isReprésenté": "unassigned", "legalRights": "unassigned","spouse": [''],}},
        ...
        {"member_id":"grand_son2","childs":[],"attributes":{"status": 'valid', "degre":"unassigned", "ordre": "unassigned", "branch": "unassigned", "isReprésentant": "unassigned", "isReprésenté": "unassigned", "legalRights": "unassigned","spouse": [''],}},
    ...
    const solution = assignDegré(Family.create(data, "deCujus", "deCujus"))
...
it('should test degrés in ordre 2', () => {
    ...
    const solution = assignDegré(Family.create(data, "deCujus", "father"))
...
it('should test degrés in ordre 3', () => {
    const data: MemberConstructor[] = [
        ...
        {"member_id":"grand_grand_grand_father","childs":["grand_grand_father"],"attributes":{"status": 'valid', "degre":"unassigned", "ordre": "unassigned", "branch": "unassigned", "isReprésentant": "unassigned", "isReprésenté": "unassigned", "legalRights": "unassigned","spouse": [''],}},
        {"member_id":"grand_grand_grand_grand_father","childs":["grand_grand_grand_father"],"attributes":{"status": 'valid', "degre":"unassigned", "ordre": "unassigned", "branch": "unassigned", "isReprésentant": "unassigned", "isReprésenté": "unassigned", "legalRights": "unassigned","spouse": [''],}},
    ...
    const solution = assignDegré(Family.create(data, "deCujus", "grand_grand_grand_grand_grand_father"))
...
it('should test degrés in ordre 4', () => {
    ...
    const solution = assignDegré(Family.create(data, "deCujus", "grand_grand_father"))
