...
describe("Inheligible wise", () => {
    it('should not give legalRights when there is no heirs', () => {
        const noMember: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
    ...
    it('should not not give legalRights to deceased members in Degre1', () => {
        const oneDeadInSameDegree: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
    ...
    it('should not give legalRights to deceased members in Degre2', () => {
        const oneDeadInSameDegreeTwo: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
...
describe('Degree wise', () => {
    it('should give equal shares between first degree', () => {
        const firstDegreeMember: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
    ...
    it('should give equal shares between second degree ', () => {
        const secondDegreesMembers: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
    ...
    it('should give equal shares between third degree', () => {
        const thirdDegreesMembers: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
    ...
    it('should give equal shares between fourth degree', () => {
        const fourthDegreesMembers: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
    ...
    it('should give equal shares between fifth degree', () => {
        const fifthDegreesMembers: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
    ...
    it('should give equal shares between sixth degree', () => {
        const sixthDegree: MemberConstructor[] = [
            {
                "childs": [],
                "attributes": {
                    "degre": 0,
...
describe('Représentation wise', () => {
    ...
    it('should give 50% to a normal heir and distribute 50% to the souche', () => {
        const oneRepresentant: MemberConstructor[] = [
            {
                "childs": [
                    "représenté",
                    "normalHeir"
    ...
    it('should give 2/3 to two normals heirs and distribute 1/3 to the souche', () => {
        const oneRepresentéTwoNormalHeirsThreeRepresentants: MemberConstructor[] = [
            {
                "childs": [
                    "représenté",
                    "normalHeir1",
    ...
    it('should work with sub-representation', () => {
        const recursiveReprésentation: MemberConstructor[] = [
            {
                "childs": [
                    "représenté",
                    "normalHeir"
